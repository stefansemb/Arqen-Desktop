...
| Röst | Taligenkänning, TTS och avbrott | `arqen/tools/speech.py`, `arqen/ui/window.py` | Hög | KEEP |
...
| Minne | Långtidsminne och användarprofil | `arqen/core/memory_store.py` | Hög | KEEP |
| Desktop | Appar, filer, fönster och systemkontroll | `arqen/tools/` | Hög | KEEP |
...
| Dokument | Dokument, PDF, presentationer och kalkylblad | `arqen/tools/*_documents.py` | Medel | KEEP |
...
| Agent | Planering, kö och exekvering | `arqen/mission/` | Medel | KEEP |
...
| UI | Desktopgränssnitt, Mission Control och status | `arqen/ui/window.py` | Hög | KEEP |
